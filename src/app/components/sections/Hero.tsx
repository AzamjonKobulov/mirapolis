...
export default function Hero() {
  ...
  return (
    <section id="hero" className="p-3.5 xs:p-0">
      <div
        className="lg:max-h-[760px] bg-hero bg-no-repeat bg-bottom-left lg:bg-cover lg:bg-left rounded-2xl xs:rounded-t-none xs:rounded-b-[2.5rem] lg:rounded-b-[4rem] xs:!pb-20 lg:pb-32 mt-12 xs:mt-0 py-7 px-3.5 xs:px-0 xs:pt-28 sm:pt-32"
